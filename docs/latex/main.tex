...
\newcommand\uni{Martin-Luther Universität Halle-Wittenberge}
...
\newcommand\exercise{-}
\newcommand\thema{Hausarbeit}
\newcommand\subtitle{\thema}
...
\fancypagestyle{firstpage}{%
    \fancyhf{}
    \chead{\color{\ruleColor}\rmfamily\scshape\nouppercase \degree ~|~ \coursetitle ~|~ \textbf{\authorname ~ -- ~ \mtrnmbr}}
